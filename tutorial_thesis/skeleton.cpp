...
void loadShaderPrograms()
{
    ...
    commonShaderProgram.locations.testingColor = glGetUniformLocation( commonShaderProgram.program, "testingColor" ); // XD
    ...
    assert( commonShaderProgram.locations.testingColor != -1 ); // XD
    // ...
...
void initApplication()
{
    ...
    objects.push_back( new Triangle( &commonShaderProgram ) ); // XD
